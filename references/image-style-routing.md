...
| 散文/共情/向往 | **AI 为主 + 网上真实场景照点睛 1-2 张**(CC0/授权图库:黄昏/操场/食堂/山海等真实照片)——2026-08-19 拍板增量 |
| 观点/思辨 | AI 为主(意象多为抽象) |
...
1.5. 🔴 **图源三问(2026-08-19 起必做)**:列出全文意象块清单,逐块过三问 → 分轨;真实图轨走 real-image-collection.md 渠道库(网上找图/下载/筛选/归因),AI 轨继续步骤 2。⚠️ 意象有真实照片更贴时,真实图优先于 AI 插画(2026-08-19 用户拍板)
